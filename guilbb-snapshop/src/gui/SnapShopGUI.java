...
public class SnapShopGUI extends JFrame {
    ...
    private final JButton myButtonOpen;
    
    /** A button to save the manipulated image. */
    private final JButton myButtonSaveAs;
    
    /** A button to close an image. */
    private final JButton myButtonCloseImage;
    ...
    private final JLabel myImageDisplayLabel;
    
    /** The image to be displayed. */
    private PixelImage myDisplayImage;
    
    /** A map of the Filters to be used and their names. */
    private final Map<String, Filter> myFiltersAndNamesMap;
    ...
    /**
     * This method resizes the window when the contents change.
     */
    private void formatWindowToSize() {
        setMinimumSize(null);
        pack();
        final Dimension border = new Dimension();
        final int widthBorder = 200;
        final int heightBorder = 20;
        border.setSize(widthBorder + getSize().getWidth(), 
                                         heightBorder + getSize().getHeight());
        setMinimumSize(border);
    }
...
//                    setMinimumSize(getSize());
     ...
     *
     */
    private final class SaveAsListener implements ActionListener {
        /**
     ...
     *
     */
    private final class FilterListener implements ActionListener {
        /**
